...
mainfont: Arial
vignette: >
  %\VignetteIndexEntry{exFINDER: identify external communication signals using single-cell transcriptomics data}
...
# this dataset can be download from: https://figshare.com/s/6538f43bf233abd9f288 
...
# merge "other" and "unassigned" to "transition"
library(forcats)

Data1@meta.data$Type <- fct_collapse(Data1@meta.data$Type, "transition"=c("other","unassigned"))
Data1@meta.data$Type <- fct_collapse(Data1@meta.data$Type, "Heart_primordium"="Heart primordium")
...
# Part III: identifying external signals that come from NON-NC cells targeting skeletal cells
...
# Part IV: identifying external signals that come from external environment targeting skeletal cells
Here, *come from external environment* means very low (or zero) expressions in the measured cells (NC and non-NC cells).
