---
title: "exFINDER_Cook2019_EMTdata_EGF"
author: "Changhan"
date: "2023-02-22"
...
Pex.1 <- get_potentialex(Graph = ltGRN,
                Exp.Data = exp.data,
                Meta.Data = meta.data,
                cutoff = -0.065, # Dataset1: -0.07 Dataset2: -0.07 Dataset3: -0.065 Dataset4: -0.08
                AG.L = c("Before"))
...
exSigNet <- get_exSigNet(Graph = ltGRN,
                       ...
                       Exp.Data = exp.data,
                       Meta.Data = meta.data,
                       # dataset1&2: (0.4, 0.65) dataset3: (0.3, 0.65) dataset4: (0.4, 1.0)
                       par.cutoff = c(0.4, 1.0), 
                       AG.R = c("On"),
                       AG.TF = c("On"))
...
# ggsave(p, filename=paste(datasets[Di], "_", inducers[Dj], "_Heatmap_EGF", ".pdf",sep=""))
```
...
# ggsave(p, filename=paste(datasets[Di], "_", inducers[Dj], "_Dendrogram_EGF", ".pdf",sep=""))
```
