---
title: "exFINDER_Cook2019_EMTdata_TGFB1"
author: "Changhan"
date: "2023-02-22"
...
Pex.1 <- get_potentialex(Graph = ltGRN,
                Exp.Data = exp.data,
                Meta.Data = meta.data,
                cutoff = -0.08, # Dataset1&2: -0.075 Dataset3: -0.065 Dataset4: -0.08
                AG.L = c("Before"))
...
exSigNet <- get_exSigNet(Graph = ltGRN,
                       ...
                       Exp.Data = exp.data,
                       Meta.Data = meta.data,
                       # dataset1&2&4: (0.65, 1.0) dataset2: (0.45, 1.0) 
                       par.cutoff = c(0.65, 1.0), 
                       AG.R = c("On"),
                       AG.TF = c("On"))
...
# ggsave(p, filename=paste(datasets[Di], "_", inducers[Dj], "_Heatmap_TGFB1", ".pdf",sep=""))
```
...
# ggsave(p, filename=paste(datasets[Di], "_", inducers[Dj], "_Dendrogram_TGFB1", ".pdf",sep=""))
```
